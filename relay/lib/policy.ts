...
export function createAuthorizationRequest({action,role,incident,team,incidents,confirmed,district='bengaluru'}:{action:'dispatch'|'resolve'|'report';role:Role;incident:Incident;team?:Team;incidents:Incident[];confirmed:boolean;district?:string}):AuthorizationCall {
 return {
...
export const cedarSchema = `namespace Relay {
 ...
 action "dispatch", "resolve", "report" appliesTo {
